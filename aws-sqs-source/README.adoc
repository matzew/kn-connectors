...
[source,text]
----
quay.io/openshift-knative/kn-connector-aws-sqs-source:1.0-SNAPSHOT
----
...
[source,shell]
----
kubectl set env deployment/kn-connector-aws-sqs-source CAMEL_KAMELET_{{KAMELET_NAME}}_{{PROPERTY_NAME}}="I updated it..."
----
...
Given a configmap named `my-aws-sqs-source-config` in Kubernetes that has two entries:

.my-aws-sqs-source-config
[source,properties]
----
...
spec:
  selector:
    matchLabels:
      app.kubernetes.io/name: aws-sqs-source
      app.kubernetes.io/version: 1.0-SNAPSHOT
  template:
    spec:
      containers:
        - image: localhost:5001/openshift-knative/aws-sqs-source:1.0-SNAPSHOT
...
* _ce-type_: dev.knative.connector.event.aws-sqs
* _ce-source_: dev.knative.eventing.aws-sqs-source
* _ce-subject_: aws-sqs-source
...
[source,shell]
----
kubectl set env deployment/kn-connector-aws-sqs-source KN_CONNECTOR_CE_OVERRIDE_TYPE=custom-type
----
